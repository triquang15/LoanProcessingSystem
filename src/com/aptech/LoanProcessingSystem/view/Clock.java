...
public class Clock extends JFrame implements MouseListener {
	...
	public Clock() {
		setTitle("Clock");
		setIconImage(Toolkit.getDefaultToolkit().getImage(Clock.class.getResource("/com/aptech/LoanProcessingSystem/images/bank (4).png")));
		// TODO Auto-generated constructor stub
		setDefaultCloseOperation(EXIT_ON_CLOSE);	
		setBounds(700, 100, 671, 396);
		getContentPane().setBackground(new Color(128, 128, 128));
		getContentPane().setLayout(null);
		
		JButton btnNewButton = new JButton("World Clock");
		btnNewButton.setBackground(Color.LIGHT_GRAY);
		btnNewButton.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 11));
		btnNewButton.setBounds(458, 45, 104, 23);
		getContentPane().add(btnNewButton);
		
		JButton btnNewButton_1 = new JButton("Alarm");
		btnNewButton_1.setBackground(Color.LIGHT_GRAY);
		btnNewButton_1.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 11));
		btnNewButton_1.setBounds(458, 103, 104, 23);
		getContentPane().add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Stopwatch");
		btnNewButton_2.setBackground(Color.LIGHT_GRAY);
		btnNewButton_2.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 11));
		btnNewButton_2.setBounds(458, 158, 104, 23);
		getContentPane().add(btnNewButton_2);
		
		JButton btnNewButton_3 = new JButton("Timer");
		btnNewButton_3.setBackground(Color.LIGHT_GRAY);
		btnNewButton_3.setFont(new Font("Times New Roman", Font.BOLD | Font.ITALIC, 11));
		btnNewButton_3.setBounds(458, 219, 104, 23);
		...
		btnNewButton_4.setIcon(new ImageIcon(Clock.class.getResource("/com/aptech/LoanProcessingSystem/images/close (2).png")));
		btnNewButton_4.setBounds(558, 325, 89, 23);
	...
	public void paint(Graphics g) {
		...
		if(status==1){
			...
			g.fillRect(centerX-40, centerY-35, 90, 20);			g.setFont(new Font("Tahoma", Font.BOLD, 12));
