...
public class AddCustomer extends JDialog {
	...
	public AddCustomer() {
		...
		rdbMale.setSelected(true);
		{
			...
			panel_1.setBounds(18, 400, 1000, 68);
			...
			btnNewButton.setIcon(new ImageIcon(AddCustomer.class.getResource("/com/aptech/LoanProcessingSystem/images/back.png")));
			...
			btnSave.setIcon(new ImageIcon(AddCustomer.class.getResource("/com/aptech/LoanProcessingSystem/images/floppy-disk.png")));
			...
			btnClear.setIcon(new ImageIcon(AddCustomer.class.getResource("/com/aptech/LoanProcessingSystem/images/arrows-circle.png")));
	...
	JLabel lblNewLabel = new JLabel(
			"New Customer");lblNewLabel.setHorizontalAlignment(SwingConstants.CENTER);lblNewLabel.setForeground(Color.RED);lblNewLabel.setFont(new Font("Tahoma",Font.BOLD|Font.ITALIC,18));lblNewLabel.setIcon(new ImageIcon(AddCustomer.class.getResource("/com/aptech/LoanProcessingSystem/images/customer (2).png")));lblNewLabel.setBounds(388,27,238,38);contentPanel.add(lblNewLabel);
	{
